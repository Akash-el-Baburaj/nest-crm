...
export const MENU: MenuItem[] = [
    ...
    { key: 'dashboards', label: 'Dashboards', isTitle: false, icon: 'uil-home-alt', link: '/apps/crm/dashboard' },

    { key: 'apps', label: 'Apps', isTitle: true },
        {
        key: 'apps-crm', label: 'CRM', isTitle: false, icon: 'uil-tachometer-fast', collapsed: true,
        ...
        children: [
            ...
            { key: 'crm-contacts', label: 'Contacts', link: '/apps/crm/contacts', parentKey: 'apps-crm' },
    ...
    { key: 'apps-calendar', label: 'Schedules', isTitle: false, icon: 'uil-calender', link: '/apps/calendar' },
